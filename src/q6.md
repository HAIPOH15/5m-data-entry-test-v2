...
**Reason 1:**  
_(uses structure framework providing specific instructions on the roles, task, audience etc)_

**Reason 2:**  
_(included constraints)_
...
**Answer:**  
_(Explanation of the format of the response includes the customer's age group, the product they purchased, their satisfaction rating from 1 to 5, and a short written comment)_
...
> _(**Data:** 500 responses, each containing age group, product purchased, satisfaction rating (1-5), and written comments._

**What you borrowed and why:**  
_(provides specific details to the model instead of having it intepret )_
